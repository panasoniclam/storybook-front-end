    ...
    return (<Auxiliary>
        ...
        <CustomScrollbars className="gx-layout-sider-scrollbar">
          <Menu
            ...
            <MenuItemGroup key="components" title={<IntlMessages
            ...
            <MenuItemGroup key="extraComponents" title={
            ...
            <MenuItemGroup key="custom-views"
                           title={
            ...
            <MenuItemGroup key="documents" title={
