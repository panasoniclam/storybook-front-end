...
class Chat extends Component {
      ...
      <div className="gx-chat-sidenav-header">
        ...
        <div className="gx-chat-user-hd">
          ...
          <div className="gx-chat-avatar gx-mr-3" onClick={() => {
            ...
            <div className="gx-status-pos">
              <Avatar id="avatar-button" src='http://via.placeholder.com/150x150'
          ...
          <div className="gx-module-user-info gx-flex-column gx-justify-content-center">
            ...
            <div className="gx-module-user-detail">
              <a href="javascript:void(0);" className="gx-text-grey">robert@example.com</a>
            </div>
          </div>
        </div>
  ...
  render() {
    const {loader, userState, drawerState, selectedUser, contactList} = this.state;
    return (
