    ...
    <Widget title={<IntlMessages id="sidebar.documents.installation"/>}>
      <div>
        ...
        <div className="adocs-section-content ng-binding">
          ...
          <ol type="i">
            <li><p>Install node modules use <span
              className="gx-bg-grey gx-py-1 gx-px-2 gx-border-radius-md">$ yarn</span>
              command</p>
            </li>
            <li>
              <p>Run app <span className="gx-bg-grey gx-py-1 gx-px-2 gx-border-radius-md">$ yarn start</span> (if app
                compiling slow just comment out some routes in routes.js
                file)</p>
            </li>
            <li>
              <p>For build production files run <span className="gx-bg-grey gx-py-1 gx-px-2 gx-border-radius-md">$ yarn build</span>
        ...
        <br/>
        <h4>
          <a target="_blank" href="http://docs.g-axon.com/flexile/">Click here for fully detailed documentation</a>
        </h4>
      </div>
